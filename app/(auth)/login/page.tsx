...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <button className="w-full flex items-center justify-center gap-2 py-2.5 border border-white/10 hover:border-white/20 text-sm text-gray-300 rounded-lg transition-colors">
      ...
      <p className="text-center text-sm text-gray-500 mt-6">
        ...
        <Link href="/signup" className="text-forest-light hover:underline">
          Sign up
        </Link>
      </p>
    </motion.div>
